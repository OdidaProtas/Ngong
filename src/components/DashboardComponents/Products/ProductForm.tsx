...
import { ButtonWithLoaderComponent, ModalDialog } from "../../SharedComponents";
...
import StatusChip from "./ProductLists/StatusChip";
                ...
                <Grid container spacing={2} mb={9}>
                  <Grid item xs={12} lg={8}>
                    <div>
                      ...
                      >
                        <Typography sx={{ mt: 2, mb: 1 }}>SHIPPING</Typography>
                        <ShippingForm
                          values={values}
                          handleChange={handleChange}
                        />
