...
export default function Appbar({ handleChangeMode, mode }: any) {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between" }}>
      <Backdrop
        open={open}
        sx={{ width: 930, marginLeft: 35.5, marginTop: 11, zIndex: 10000 }}
      >
        <div
          style={{
            position: "absolute",
      ...
      <div style={{ display: "flex" }}>
        ...
        {mode === "desktop" ? (
          <Box sx={{ ml: 3, display: "flex", mt: 1 }}>
            <Typography sx={{ mr: 1, cursor: "pointer" }}>catalog</Typography>
            <Typography sx={{ mr: 1, cursor: "pointer" }}>about</Typography>
            <Typography sx={{ mr: 1, cursor: "pointer" }}>blog</Typography>
            <Typography sx={{ mr: 1, cursor: "pointer" }}>contact</Typography>
          </Box>
        ) : null}
      </div>
      <div>
