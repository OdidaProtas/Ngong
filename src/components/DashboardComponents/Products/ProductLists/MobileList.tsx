...
import MobileSelectedHeader from "./MobileSelectedHeader";
...
export default function MobileList({ context }) {
            ...
            <TableBody>
              ...
              {rows.length < 1 && (
                ...
                >
                  <div>
                    <Search sx={{m:2}} />
                    <Typography sx={{m:2}}>No products found matching filter</Typography>
                  </div>
                </TableRow>
              )}
            </TableBody>
    ...
    <React.Fragment>
      ...
      >
        ...
        <TableCell align="left" id={labelId} padding="none">
          ...
          {!dense && <Typography variant="caption">{row.vendor}</Typography>}
        </TableCell>
